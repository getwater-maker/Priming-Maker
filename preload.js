...
contextBridge.exposeInMainWorld('api', {
  ...
  getRunpodKey: () => ipcRenderer.invoke('get-runpod-key'),
  setRunpodKey: (key) => ipcRenderer.invoke('set-runpod-key', key),
  getRunpodConfig: () => ipcRenderer.invoke('get-runpod-config'),
  setRunpodConfig: (patch) => ipcRenderer.invoke('set-runpod-config', patch),
  runpodStart: () => ipcRenderer.invoke('runpod-start'),
  runpodStop: () => ipcRenderer.invoke('runpod-stop'),
  runpodStatus: () => ipcRenderer.invoke('runpod-status'),
